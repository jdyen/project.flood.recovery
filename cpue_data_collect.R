...
catch.cpue_wetmap <- fetch_query( "SELECT id_site::integer, waterbody, site_name, id_project, survey_year, survey_date, gear_type, scientific_name, effort_h, catch, cpue FROM projects.v_floods_wetmap_cpue", collect = TRUE)

catch.cpue <- catch.cpue[,c("id_site", "waterbody", "site_name", "id_project", "survey_year", "survey_date", "gear_type", "scientific_name", "effort_h", "catch", "cpue")]
catch.cpue <- rbind(catch.cpue, catch.cpue_wetmap)
remove(catch.cpue_wetmap)
#.................................................................................................................................................

#Define geartype as either eletrofshing or netting
catch.cpue$gear_type <- ifelse(catch.cpue$gear_type == 'netting', catch.cpue$gear_type, "electrofishing")
...
catch.cpue_ba <- catch.cpue_filtered
